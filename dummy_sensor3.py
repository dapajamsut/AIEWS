...
# ==========================================
# KONFIGURASI MQTT (DISESUAIKAN UNTUK VPS)
# ==========================================
# Broker MQTT di VPS. Port 1883 sudah di-expose ke host pada docker-compose.
# - Jika script dijalankan DARI LUAR VPS  : gunakan domain/IP publik VPS.
# - Jika script dijalankan DI DALAM VPS    : bisa juga pakai "127.0.0.1".
MQTT_BROKER = "makesens.my.id"
MQTT_PORT   = 1883
