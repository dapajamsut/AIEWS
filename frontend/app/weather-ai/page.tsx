...
export default function WeatherAIPage() {
  ...
  const getNoteIcon = (type: string) => {
    switch (type) {
      ...
      default:
        return <Plus className="size-4 text-gray-600 dark:text-gray-400" />;
    }
  };
  ...
  return (
    <Layout>
      <div className="space-y-6 max-w-7xl mx-auto">
        ...
        {/* Current Weather & AI Prediction Row */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="p-5 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-blue-100 dark:bg-blue-950 rounded-lg">
                <Thermometer className="size-5 text-blue-600 dark:text-blue-400" />
              </div>
              <div>
          ...
          <Card className="p-5 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-purple-100 dark:bg-purple-950 rounded-lg">
                <Wind className="size-5 text-purple-600 dark:text-purple-400" />
              </div>
              <div>
                <p className="text-xs text-gray-600 dark:text-gray-400">Wind Speed</p>
                <p className="text-xl font-bold text-gray-900 dark:text-white">18 km/h</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-5 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800">
            <div className="flex items-center gap-3">
              <div className="p-2.5 bg-orange-100 dark:bg-orange-950 rounded-lg">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-gray-900 dark:text-white">5.2 km</p>
              </div>
            </div>
          </Card>
        </div>
        ...
        <Card className="p-6 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 pb-16">
          ...
          <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              Add New Manual Analysis
            </label>
            <div className="flex gap-2">
              <Textarea
                placeholder="Enter observation, analysis, or manual prediction..."
                value={newNote}
                onChange={(e) => setNewNote(e.target.value)}
                className="flex-1 min-h-[80px]"
              />
              <Button onClick={handleAddNote} className="gap-2 bg-blue-600 hover:bg-blue-700">
